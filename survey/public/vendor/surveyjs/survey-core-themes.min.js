...
!(function (e, r) {
	...
	(() => {
					...
					const s = {
						...
						cssVariables: {
							...
							"--sjs-shadow-small-reset":
								"0px 0px 0px 0px rgba(255, 255, 255, 0.12)",
							"--sjs-shadow-medium":
								"0px 0px 0px 1px rgba(255, 255, 255, 0.12),0px 2px 6px 0px rgba(0, 0, 0, 0.2)",
				...
				221: (e, r, a) => {
					...
					const s = {
						...
						cssVariables: {
							...
							"--sjs-shadow-small-reset":
								"0px 0px 0px 0px rgba(64, 64, 64, 1),0px 0px 0px 0px rgba(64, 64, 64, 1)",
							"--sjs-shadow-medium":
								"0px 0px 0px 2px rgba(64, 64, 64, 1),0px 8px 0px 2px rgba(64, 64, 64, 1)",
				...
				274: (e, r, a) => {
					...
					const s = {
						...
						cssVariables: {
							...
							"--sjs-shadow-small-reset":
								"0px 0px 0px 0px rgba(255, 255, 255, 0.28)",
							"--sjs-shadow-medium":
								"0px 0px 0px 1px rgba(255, 255, 255, 0.25),0px 2px 6px 0px rgba(0, 0, 0, 0.2)",
							"--sjs-shadow-large": "0px 8px 16px 0px rgba(0, 0, 0, 0.2)",
							"--sjs-shadow-inner": "0px 0px 0px 1px rgba(255, 255, 255, 0.22)",
							"--sjs-shadow-inner-reset":
								"0px 0px 0px 0px rgba(255, 255, 255, 0.22)",
				...
				815: (e, r, a) => {
					...
					const s = {
						...
						cssVariables: {
							...
							"--sjs-shadow-medium":
								"0px 0px 0px 2px rgba(0, 0, 0, 0.08),0px 2px 6px 0px rgba(0, 0, 0, 0.04)",
				...
				907: (e, r, a) => {
					...
					const s = {
						...
						cssVariables: {
							...
							"--sjs-shadow-small-reset":
								"0px 0px 0px 0px rgba(255, 255, 255, 0.09)",
							"--sjs-shadow-medium":
								"0px 0px 0px 1px rgba(255, 255, 255, 0.12),0px 2px 6px 0px rgba(0, 0, 0, 0.2)",
							"--sjs-shadow-large": "0px 8px 16px 0px rgba(0, 0, 0, 0.2)",
		...
		a.r(s),
			a.d(s, {
				BorderlessDark: () => x.default,
				BorderlessDarkPanelless: () => b.default,
				BorderlessLight: () => f.default,
				BorderlessLightPanelless: () => p.default,
				ContrastDark: () => z.default,
				ContrastDarkPanelless: () => E.default,
				ContrastLight: () => q.default,
				ContrastLightPanelless: () => A.default,
				DefaultDark: () => l.default,
				DefaultDarkPanelless: () => n.default,
				DefaultLight: () => t.default,
				DefaultLightPanelless: () => o.default,
				DoubleBorderDark: () => C.default,
				DoubleBorderDarkPanelless: () => I.default,
				DoubleBorderLight: () => D.default,
				DoubleBorderLightPanelless: () => H.default,
				FlatDark: () => m.default,
				FlatDarkPanelless: () => u.default,
				FlatLight: () => d.default,
				FlatLightPanelless: () => h.default,
				LayeredDark: () => P.default,
				LayeredDarkPanelless: () => N.default,
				LayeredLight: () => W.default,
				LayeredLightPanelless: () => L.default,
				PlainDark: () => S.default,
				PlainDarkPanelless: () => w.default,
				PlainLight: () => y.default,
				PlainLightPanelless: () => k.default,
				SharpDark: () => g.default,
				SharpDarkPanelless: () => j.default,
				SharpLight: () => i.default,
				SharpLightPanelless: () => c.default,
				SolidDark: () => B.default,
				SolidDarkPanelless: () => _.default,
				SolidLight: () => V.default,
				SolidLightPanelless: () => v.default,
				ThreeDimensionalDark: () => F.default,
				ThreeDimensionalDarkPanelless: () => M.default,
				ThreeDimensionalLight: () => T.default,
				ThreeDimensionalLightPanelless: () => O.default,
				__surveyjs_internal_themes_hash: () => G,
				default: () => J,
			});
		var t = a(695),
			l = a(663),
