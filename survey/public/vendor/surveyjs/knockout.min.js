		...
		(function (n) {
				...
				return {
					...
					B: function (b, c, d) {
						...
						if (a.options.useOnlyNativeEvents || d || !v)
							...
							t || (t = "function" == typeof v(b).on ? "on" : "bind"), v(b)[t](c, e);
					},
					Fb: function (b, c) {
						if (!b || !b.nodeType)
			...
			a.ta = function (b) {
				function c() {
					if (0 < arguments.length)
						return (
							c.sb(c[I], arguments[0]) && (c.ya(), (c[I] = arguments[0]), c.xa()),
							this
						);
					a.u.cc(c);
					return c[I];
			...
			(function () {
				...
				function d(d, e) {
					...
					if (!e)
						throw Error("Cannot find closing comment tag to match: " + d.nodeValue);
					return null;
				}
				function e(a, b) {
					var c = d(a, b);
				...
				a.h = {
					...
					firstChild: function (a) {
						...
						if (a.firstChild && c(a.firstChild))
							throw Error("Found invalid end comment, as the first child of " + a);
						return a.firstChild;
					},
			...
			(function () {
				...
				function p(b, c, d) {
					...
					f = u === n;
					return { shouldBindDescendants: f, bindingContextForDescendants: f && x };
				}
				function q(b, c) {
			...
			a.c.options = {
				...
				update: function (b, c, d) {
					...
					l ||
						(h
							? (t = a.a.Mb(e(), a.w.M))
							: 0 <= b.selectedIndex && t.push(a.w.M(b.options[b.selectedIndex])));
					k &&
			...
			(function () {
				...
				function e(b, e, f, h, m) {
					...
					n &&
						(c(f, h),
						m.afterRender && a.u.G(m.afterRender, null, [f, h[m.as || "$data"]]),
